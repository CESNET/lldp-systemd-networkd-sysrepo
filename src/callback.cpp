...
int Callback::operator()(::sysrepo::S_Session session, const char* module_name, const char* xpath, const char* request_xpath, uint32_t request_id, libyang::S_Data_Node& parent)
{

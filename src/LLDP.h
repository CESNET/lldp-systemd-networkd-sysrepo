...
typedef std::unique_ptr<sd_lldp_neighbor, sd_lldp_neighbor_deleter> sd_lldp_neighbor_managed;

class LLDPDataProvider {
public:
    LLDPDataProvider (std::filesystem::path dataDirectory, sdbus::IConnection& dbusConnection);

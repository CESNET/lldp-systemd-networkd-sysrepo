...
class DbusServer {
public:
    DbusServer(sdbus::IConnection& connection, sdbus::ObjectPath objectPath, std::string interface);
...
private:
    ...
    std::vector<sdbus::Struct<int, std::string, sdbus::ObjectPath>> ListLinks() const;
};